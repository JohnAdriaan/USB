; First, set up the Segment Regsisters and Stack
0000  FA         CLI
0001  B80000     MOV  AX,0x0000
0004  8ED0       MOV  SS,AX
0006  BC007C     MOV  SP,0x7C00
0009  8BF4       MOV  SI,SP
000B  50         PUSH AX
000C  07         POP  ES
000D  50         PUSH AX
...
0010  FC         CLD
0011  BF0006     MOV  DI,0x0600
0014  B90001     MOV  CX,0x0100
0017  F3A5       REP  MOVSW
0019  EA1E060000 JMP WORD 0x0000:0x061E

; Is first Partition active?
061E  BEBE07     MOV  SI,0x07BE
0621  803C80     CMP BYTE [SI],0x80
0624  7402       JZ   0x0628
...
0643  813D5553   CMP WORD [DI],0x5355
...
0658  EB15       JMP SHORT 0x066F ; Load!
...
0668  CD10       INT  0x10
066A  5E         POP  SI
066B  EBF0       JMP SHORT 0x065D

; Loop forever
066D  EBFE       JMP SHORT 0x066D
